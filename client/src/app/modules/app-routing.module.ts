...
import { pinVerificationGuard } from '@app/guards/pin-verification.guard';
...
import { NameDefinitionPageComponent } from '@app/pages/name-definition-page/name-definition-page.component';
...
const routes: Routes = [
    ...
    { path: 'name-definition', component: NameDefinitionPageComponent, canActivate: [pinVerificationGuard] },
